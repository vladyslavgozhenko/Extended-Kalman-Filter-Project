...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
   ...
   ****************************************************************************/
  if (!is_initialized_) {
    // Initialization of the state ekf_.x_ with the first measurement.
    // first measurement
    cout << "EKF: " << endl;
    ekf_.x_ = VectorXd(4);
    ekf_.x_ << 1, 1, 1, 1;
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      /**
      Converts radar from polar to cartesian coordinates and initializes state.
      */
      ...
      Initializes state.
      */
      //sets the state with the initial location and zero velocity
  ...
  /**
     * Updates the state of transition matrix F according to the new elapsed time.
   ...
   */
   ...
   //sets the process covariance matrix Q
